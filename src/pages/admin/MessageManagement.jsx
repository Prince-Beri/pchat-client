...
const columns = [
  ...
  },
  {
    ...
    renderCell: (params) => {
     ...
     : <span style={{ color: 'rgba(100, 50, 50, 0.2)'}}>No Attachments</span>
    }
  },
  {
    field: 'content',
    ...
    headerClassName: 'table-header',
    width: 400,
    renderCell: (params) => params.row.content.length > 0 ? params.row.content 
      : <span style={{ color: 'rgba(100, 50, 50, 0.2)'}}>No Content</span>, 
  },
  {
    field: 'sender',
    headerName: 'Send By',
