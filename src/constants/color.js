...
export const bgGradient = 'linear-gradient(330deg, rgb(255, 255, 209), rgb(249, 159, 159))';
export const purple = 'rgba(75, 12, 192, 1)';
export const purpleLight = 'rgba(75, 12, 192, 0.2)';
export const blue = 'rgba(75, 192, 192, 1)';
export const blueLight = 'rgba(75, 192, 192, 0.2)';
